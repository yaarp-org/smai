    ...
    <div className="space-y-4">
      <header className="space-y-1">
        ...
        <p className="text-sm text-[var(--color-fg-subtle)]">
          One comparison group per "does X beat Y?" question: a baseline plus one or more treatment
          entries that share controlled conditions. SMAI's agents implement them, run them, and
          report a verdict.
        </p>
      </header>
