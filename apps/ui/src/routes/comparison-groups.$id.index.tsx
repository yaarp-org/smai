  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Identifiers and content hashes for this comparison group.</CardDescription>
      </CardHeader>
      <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          One row per entry in this comparison. The baseline plus each technique variant.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {cg.entries.length === 0 ? (
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          What the agents are doing right now — harness builder progress and per-entry status.
        </CardDescription>
      </CardHeader>
          ...
          <>
            <div>
              ...
              {status.harness == null ? (
                <p className="mt-1 text-[var(--color-fg-subtle)]">
                  Harness builder hasn't started yet.
                </p>
              ) : (
            ...
            <div>
              ...
              {Object.keys(status.entries).length === 0 ? (
                <p className="mt-1 text-[var(--color-fg-subtle)]">
                  No entry agents have started yet.
                </p>
              ) : (
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          The verdict for this comparison — pass, fail, or inconclusive — plus the metrics behind
          it.
        </CardDescription>
      </CardHeader>
        ...
        {result && (
          <>
            ...
            <p className="text-xs text-[var(--color-fg-subtle)]">
              Raw metrics and per-entry verdicts (JSON; a structured viewer lands later).
            </p>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Files this comparison produced — the harness, each entry's code, evaluation results,
          code-review output. Browse them at{" "}
