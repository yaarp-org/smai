      ...
      <header className="flex flex-wrap items-center gap-3">
        <div className="flex-1 space-y-1">
          ...
          <p className="text-sm text-[var(--color-fg-subtle)]">
            Each proposal is a description of a comparison you want to test. The planner agent
            designs it into one or more comparison groups; you approve before they run.
          </p>
        </div>
