...
:class:`smai_agents.tools.Tool` primitive shipped in 2.B1:
...
The ``finish`` tool ships from :mod:`smai_agents.tools`
(:func:`smai_agents.tools.make_finish_tool`); it is part of the loop
...
constructs a :class:`smai_agents.tools.ToolRegistry` populated with the
