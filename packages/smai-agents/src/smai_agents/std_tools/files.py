...
:func:`smai_agents.between_turn.lint_after_python_write` via
...
def _error_result(message: str) -> ToolResultContent:
    ...
    :func:`smai_agents.loop._execute_tool_uses`.
    """
...
def make_write_file_tool() -> Tool:
    ...
    Binds :func:`smai_agents.between_turn.lint_after_python_write` as a
