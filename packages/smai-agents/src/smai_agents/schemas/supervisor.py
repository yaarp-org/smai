...
* :func:`smai_agents.agents.supervisor.run_supervisor_check` — the
  role-shaped wrapper that hands this to :func:`smai_agents.structured_call`
  as ``output_schema``.
* :func:`smai_agents.between_turn.maybe_run_supervisor_check` — the
