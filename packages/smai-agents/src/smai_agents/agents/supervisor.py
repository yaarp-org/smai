...
(:func:`smai_agents.between_turn.maybe_run_supervisor_check`) translates
...
from smai_agents.schemas.supervisor import SupervisorDecision
...
class SupervisorInput(BaseModel):
    ...
    *what* triggered the check (``'periodic'``, ``'no_progress'``, etc.).
    ...
    :class:`smai_agents.AgentSession.turn_count`."""

    turn_budget: int
    """Maximum turns the loop is configured for. Per
    :attr:`smai_agents.AgentLoopConfig.max_turns`."""
