...
* **Single-call agents** (code reviewer / contextual evaluator /
  ...
  structured-output tool via :func:`smai_inline_agents.structured_call`.
...
from smai_inline_agents.std_tools.execute import EXECUTE_TOOL_NAME, make_execute_tool
...
from smai_inline_agents.tools import ToolRegistry, make_finish_tool
...
def build_standard_tool_registry(
    *,
    ...
    if RUN_EXPERIMENT_TOOL_NAME not in excluded:
        from smai_inline_agents.std_tools.run_experiment import (  # noqa: PLC0415
