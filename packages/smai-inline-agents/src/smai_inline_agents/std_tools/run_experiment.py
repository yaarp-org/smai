...
* **Sandbox boundary is enforced by the Compute plugin** (per
  ...
  :func:`smai_inline_agents.between_turn.wait_for_compute_job`; the agent
...
from smai_inline_agents.between_turn import wait_for_compute_job
...
# Tighter than :data:`smai_inline_agents.between_turn.DEFAULT_COMPUTE_POLL_INTERVAL`
...
# is :func:`smai_inline_agents.between_turn.wait_for_compute_job`; tests pass
    ...
    *,
    ...
    Args:
        ...
        wait_helper: Test-only seam. Defaults to
            :func:`smai_inline_agents.between_turn.wait_for_compute_job`.
...
def _build_command(
    *,
    ...
    :func:`smai_inline_agents.agents.manifest_tool` reads to decide whether
