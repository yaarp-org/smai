...
# Char-count heuristic — same factor used in :mod:`smai_inline_agents.truncation`.
_CHARS_PER_TOKEN = 4
...
class Tool(BaseModel):
    ...
    :func:`smai_inline_agents.between_turn.lint_after_python_write`) without
...
class FinishInput(BaseModel):
    ...
    :class:`smai_inline_agents.loop.AgentOutcome`.
    """
...
def truncate_tool_output(
    ...
    *,
    ...
    char-count heuristic used by :mod:`smai_inline_agents.truncation` (~4
