""":func:`smai_inline_agents.retry_context.load_retry_context` round-trip."""
...
from smai_inline_agents import PREV_CONVERSATION_TRACE_FILENAME, load_retry_context
...
async def test_run_loop_persists_trace_picked_up_by_load_retry_context(
    ...
    from smai_inline_agents.loop import AgentSession, TextContent, run_loop
    from smai_inline_agents.tools import ToolRegistry
