""":func:`smai_inline_agents.run_code_review` — Task 2.B4 acceptance.
...
from smai_inline_agents.agents import code_reviewer as _code_reviewer_module
    ...
    def _fake_loader(*, role: str, variant_name: str | None = None) -> PromptConfig:
        ...
        return PromptConfig(
            ...
            structured_output_tool=StructuredOutputTool(
                ...
                schema_module=("smai_inline_agents.schemas.code_review:CodeReviewResult"),
            ),
