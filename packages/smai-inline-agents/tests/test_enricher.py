""":func:`smai_inline_agents.run_technique_enrichment` — Task 3.E2 acceptance.
...
from smai_inline_agents.agents.enricher import (
    EnricherInput,
    run_technique_enrichment,
)
from smai_inline_agents.schemas.enricher import EnrichmentResult
