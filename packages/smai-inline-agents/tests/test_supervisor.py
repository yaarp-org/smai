""":func:`smai_inline_agents.run_supervisor_check` — Task 3.G4 acceptance.
...
from smai_inline_agents.agents import supervisor as _supervisor_module
    ...
    def _fake_loader(*, role: str, variant_name: str | None = None) -> PromptConfig:
        ...
        return PromptConfig(
            ...
            structured_output_tool=StructuredOutputTool(
                ...
                schema_module="smai_inline_agents.schemas.supervisor:SupervisorDecision",
            ),
